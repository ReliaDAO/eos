...
[[ $MEM_GIG -lt 1 ]] && echo "Your system must have 1 or more Gigabytes of physical memory installed." && exit 1
[[ "${DISK_AVAIL}" -lt "${DISK_MIN}" ]] && echo " - You must have at least ${DISK_MIN}GB of available storage to install Relia." && exit 1
